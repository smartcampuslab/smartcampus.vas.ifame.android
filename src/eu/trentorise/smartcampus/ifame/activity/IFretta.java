...
public class IFretta extends Activity {
	 ...
	 * mensa_list); ifretta_listView.setAdapter(adapter);
	 * 
	 * mensa_list.add(0, new WebcamMensa(Mensa.POVO_O, url_povo_0));
	 * mensa_list.add(1, new WebcamMensa(Mensa.POVO_1, url_povo_1));
	 * mensa_list.add(2, new WebcamMensa(Mensa.FBK, "")); mensa_list.add(3, new
	 * WebcamMensa(Mensa.TOMMASO_GAR, url_tom_gar)); mensa_list.add(4, new
	 * WebcamMensa(Mensa.XXIV_MAGGIO, "")); mensa_list.add(5, new
	 ...
	 * val_at.getTipo_mensa()); i.putExtra("img_url", val_at.getLink_webcam());
	 * startActivity(i); }
	 * 
	 ...
	 * new Intent(IFretta.this, IFretta_Details.class); i.putExtra("mensa",
	 * val_at.getTipo_mensa()); i.putExtra("img_url", val_at.getLink_webcam());
	 * startActivity(i);
	 * 
	 * }
	 ...
	 * List<WebcamMensa> objects) { super(context, textViewResourceId, objects);
	 * }
	 * 
	 ...
	 * nome_mensa.setTypeface(myTypeface); // TextView url_mensa = (TextView)
	 * convertView // .findViewById(R.id.mensa_urlView);
	 * 
	 * WebcamMensa w_mensa = getItem(position);
	 * nome_mensa.setText(w_mensa.getTipo_mensa() + " "); //
	 * url_mensa.setText(w_mensa.getLink_webcam() + " "); return convertView; }
	 */
