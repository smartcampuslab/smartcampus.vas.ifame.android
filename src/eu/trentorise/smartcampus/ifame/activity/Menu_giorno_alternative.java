...
import eu.trentorise.smartcampus.ifame.R.layout;
	...
	public class Menu_giorno_alternative extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			final MyArrayAdapter adapter_primi_alternative = new MyArrayAdapter(this,
			...
			final MyArrayAdapter adapter_secondi_alternative = new MyArrayAdapter(this,
					layout.layout_list_view, lista_secondi_alternative);
			...
			final MyArrayAdapter adapter_contorni_alternative = new MyArrayAdapter(this,
					layout.layout_list_view, lista_contorni_alternative);
			...
			//listaprimi
			ListAdapter listAdapterPrimi_alternative =  listaprimi_alternative.getAdapter();

		    int rowsPrimi_alt = listAdapterPrimi_alternative.getCount() ;
		    int heightPrimi_alt = 60 * rowsPrimi_alt; 
		    ViewGroup.LayoutParams paramsPrimi_alt = listaprimi_alternative.getLayoutParams();
		  ...
		  //listasecondi
			ListAdapter listAdapterSecondi_alternative =  listasecondi_alternative.getAdapter();

		    int rowsSecondi_alt = listAdapterSecondi_alternative.getCount() ;
		    int heightSecondi_alt = 60 * rowsSecondi_alt; 
		    ViewGroup.LayoutParams paramsSecondi_alt = listasecondi_alternative.getLayoutParams();
		  ...
		  //listacontorni
			ListAdapter listAdapterContorni_alternative =  listacontorni_alternative.getAdapter();

		    int rowsContorni_alt = listAdapterContorni_alternative.getCount() ;
		    int heightContorni_alt = 60 * rowsContorni_alt; 

		    ViewGroup.LayoutParams paramsContorni_alt = listacontorni_alternative.getLayoutParams();
