	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		confirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// queste variabili servono a salvare se un piatto pu� essere
				...
				// ridotto insalatona
					...
					// non fare niente, non puoi pi� prendere altro a parte il
					// pane
				...
				// se ha preso 2 contorni e 1 dessert a questo pu� scegliere da
				...
				// se ha preso 2 TRA contorni e dessert allora pu� scegliere
